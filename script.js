...
var cardDataCisarua = [
    {
        id: "1",
        image: "images/almadina-baFqih-ID1/1.jpg",
        location: "خلف مطعم بافقيه",
        price: "مليون واربع مئة وخمسين روبية يوميا"
    },
    {
        id: "2",
        image: "images/taxas1-choprial-ID2/2.jpg",
    ...
    },
    {
        ...
        location: "قريب من سوق سيساروا",
        price: "مليون وخمس مئة وأربعين روبية يوميا"
    },
    {
        id: "4",
        image: "images/villa1.JPG",
        location: "بجانب مطعم بافقيه مقابل منطقة السلام عليكم الجديدة",
        price: "مليون وخمس مئة وأربعين روبية يوميا"
    },
    {
        id: "5",
...
var cardDataCipanas = [
    ...
    },
    {
        id: "2",
        image: "images/villa1.JPG",
        location: "مقابل منطقة تمان سفاري",
        price: "ثلاثة مليون يوميا"
    },
    {
        id: "3",
        image: "images/villa1.JPG",
        location: "بداخل حارة تشيبوريال",
        price: "مليونين وخمس مئة يوميا"
    },
    {
        id: "4",
        image: "images/villa1.JPG",
...
var villaDetailsCisarua = [
    null,
    {
        image: ["images/almadina-baFqih-ID1/1.jpg", "images/almadina-baFqih-ID1/2.jpg", "images/almadina-baFqih-ID1/3.jpg", "images/almadina-baFqih-ID1/4.jpg", "images/almadina-baFqih-ID1/5.jpg", "images/almadina-baFqih-ID1/6.jpg", "images/almadina-baFqih-ID1/7.jpg", "images/almadina-baFqih-ID1/8.jpg", "images/almadina-baFqih-ID1/9.jpg", "images/almadina-baFqih-ID1/10.jpg", "images/almadina-baFqih-ID1/11.jpg", "images/almadina-baFqih-ID1/12.jpg",],
        video: "images/x.MOV",
        location: "فيلا للعوائل فقط خلف مطعم بافقيه",
        description:"ثلاث غرف مع مكيف مركزي ودوره مياه لكل غرفة - مسبح - حديقة بسيطة",
        price: "السعر بعد الخصم = مليون واربع مئة وخمسين روبيه يوميا",
        villaNumber: "1"
    },
    {
        image: ["images/taxas1-choprial-ID2/2.jpg", "images/taxas1-choprial-ID2/3.jpg", "images/taxas1-choprial-ID2/4.jpg", "images/taxas1-choprial-ID2/5.jpg", "images/taxas1-choprial-ID2/6.jpg", "images/taxas1-choprial-ID2/7.jpg", "images/taxas1-choprial-ID2/8.jpg", "images/taxas1-choprial-ID2/9.jpg", "images/taxas1-choprial-ID2/10.jpg", "images/taxas1-choprial-ID2/11.jpg", "images/taxas1-choprial-ID2/12.jpg", "images/taxas1-choprial-ID2/13.jpg", "images/taxas1-choprial-ID2/14.jpg", "images/taxas1-choprial-ID2/15.jpg", "images/taxas1-choprial-ID2/16.jpg", "images/taxas1-choprial-ID2/17.jpg", "images/taxas1-choprial-ID2/18.jpg", "images/taxas1-choprial-ID2/19.jpg", "images/taxas1-choprial-ID2/20.jpg", "images/taxas1-choprial-ID2/21.jpg", "images/taxas1-choprial-ID2/22.jpg",],
        video: "images/x.MOV",
        location: "فيلا بداخل تشوبريال تشوكلت",
        description: "في الدور الاول صالة كبيرة - غرفتين مع مكيف مركزي ودورة مياه لكل غرفة - مطبخ - وفي الدور الارضي صالة - اربع غرف مع مكيف مركزي ودوره مياه لكل غرفة - مطبخين - طاولة بلياردو - مسبح - جلسة خارجية- حديقة بسيطة",
        price: "السعر بعد الخصم = اربعة مليون واربع مئة وخمسين روبية يوميا",
        villaNumber: "2"
    },
    {
        image: ["images/villa1.JPG", "images/villa1.JPG", "images/villa1.JPG"],
        video: "images/x.MOV",
        location: "Next To Taman-Safari Area",
        description: "Sooooo Good Place",
        price: "One Millon A Day",
        villaNumber: "3"
    },
    {
        image: ["images/villa1.JPG", "images/villa1.JPG", "images/villa1.JPG"],
    ...
    },
    {
        ...
        video: "images/x.MOV",
        location: "Next To Taman-Safari Area",
        description: "The Best House You Can Ever Have",
        price: "Three Millons and Five Thousnads A Day",
        villaNumber: "5"
    },
    {
        image: ["images/villa1.JPG", "images/villa1.JPG", "images/villa1.JPG"],
    ...
    function updateVillaDetailsInfo() {
        ...
        var villa_Details_Info = `
            ...
            <div id="villa_Details_Video_Area" class="hide_Display">
                <video controls title="احجز مكاني في فلل اندونيسيا" id="villa_Details_Video" class="hide_Display">
        ...
        var photo_Villa_Details_Btn = document.getElementById("photo_Villa_Details_Btn");
        var video_Villa_Details_Btn = document.getElementById("video_Villa_Details_Btn");
        var arrow_Forward = document.getElementById("arrow_Forward");
        var arrow_Back = document.getElementById("arrow_Back");
        var villa_Details_Video_Area = document.getElementById("villa_Details_Video_Area");
        var villa_Details_Video = document.getElementById("villa_Details_Video");
        var villa_Details_Img_Area = document.getElementById("villa_Details_Img_Area");
        var villa_Details_Full_Screen_Image = document.getElementById("villa_Details_Full_Screen_Image");
...
var all_Comments_Area = document.getElementById("all_Comments_Area");
...
function updateCommentInfo() {
  ...
  `;
    ...
    var comment_Info_Image = document.getElementById("comment_Info_Image"); // Get the image element
    ...
    // Open the full-screen image when the image is clicked
    ...
    `;
        ...
        // Append the full-screen image and overlay to the body
        document.body.appendChild(fullScreenImage);
        document.body.appendChild(overlay);

        // Close the full-screen image when clicking anywhere on it or outside of it
        fullScreenImage.onclick = function () {
            closeFullScreenImage();
        };
        ...
        // Add a scroll event listener to close the full-screen image on scroll
